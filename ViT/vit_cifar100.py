...
class EncoderBlock(nn.Module):
    ...
    def __init__(self, dim, heads, mlp_ratio=4, dropout=0.1, drop_path=0.0):
        super().__init__()
...
class TransformEncoder(nn.Module):
    ...
    def __init__(self, depth, dim, heads, drop_path=0.1):
        super().__init__()
...
class ViTEncoder(nn.Module):
    ...
    def __init__(
        ...
        self.patch = PatchEmbedding(image_size, patch_size, in_channels, embed_dim)

        num_tokens = self.patch.num_patches + 1

        self.cls = CLSToken(embed_dim)
...
class ViT(nn.Module):
    ...
    def __init__(
        ...
        self.encoder = ViTEncoder(image_size, patch_size, 3, embed_dim, depth, heads)
